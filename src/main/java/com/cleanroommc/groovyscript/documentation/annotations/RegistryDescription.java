 ...
 *     <code>groovyscript.wiki.{@link ModSupport.Container#getId()}.{@link VirtualizedRegistry#getName()}.title</code>
 *     </li>
 *     <li>
 *     {@link #description()} is a localization key that is autogenerated with a base of
 *     <code>groovyscript.wiki.{@link ModSupport.Container#getId()}.{@link VirtualizedRegistry#getName()}.description</code>
 *     </li>
 *     <li>{@link #linkGenerator()} is the name, typically a modid, of a {@link com.cleanroommc.groovyscript.documentation.LinkGenerator} contained in the LinkGenerator REGISTRY.
...
public @interface RegistryDescription {
     ...
     * <code>
     * groovyscript.wiki.{@link ModSupport.Container#getId()}.{@link VirtualizedRegistry#getName()}.title
     * </code>
     *
     ...
     * <code>
     * groovyscript.wiki.{@link ModSupport.Container#getId()}.{@link VirtualizedRegistry#getName()}.description
     * </code>
     *
     ...
     * Addons should create their own instance of the {@link com.cleanroommc.groovyscript.documentation.LinkGenerator LinkGenerator} class,
     * preferably with the name of the generator being set to the modid.
     * By default, the {@link com.cleanroommc.groovyscript.documentation.LinkGenerator LinkGenerator} converts to a link towards CleanroomMC's Groovyscript
     * repo set to view the repo at a specific version tag.
     *
     * @return a string corresponding to a {@link com.cleanroommc.groovyscript.documentation.LinkGenerator LinkGenerator}, which controls how the source code link is generated.
     * Defaults to Groovyscript's modid ({@code groovyscript}).
     * @see com.cleanroommc.groovyscript.documentation.LinkGenerator LinkGenerator
     */
    String linkGenerator() default Tags.ID;
