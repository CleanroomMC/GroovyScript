...
@RegistryDescription
public class AlloyKiln extends VirtualizedRegistry<AlloyRecipe> implements IJEIRemoval.Default {
    ...
    public @NotNull Collection<String> getCategories() {
        return Collections.singletonList("ie.alloysmelter");
    }

    @Override
    public @NotNull List<IOperation> getJEIOperations() {
        return ImmutableList.of(ItemOperation.defaultOperation().include(2));
    }
