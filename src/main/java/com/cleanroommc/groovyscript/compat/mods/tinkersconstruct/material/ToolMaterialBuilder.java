...
public class ToolMaterialBuilder {
    ...
    public Material register() {
        ...
        repairIngredients.forEach(repair -> {
            if (repair.ingredient instanceof OreDictIngredient) material.addItem(((OreDictIngredient) repair.ingredient).getOreDict(), repair.amountNeeded, repair.amountMatched);
            else material.addItem(repair.ingredient.getMatchingStacks()[0], repair.amountNeeded, repair.amountMatched);
        });
