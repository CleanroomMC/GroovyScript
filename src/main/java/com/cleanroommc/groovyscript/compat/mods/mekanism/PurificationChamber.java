...
public class PurificationChamber extends VirtualizedMekanismRegistry<PurificationRecipe> {
    ...
    @MethodDescription(description = "groovyscript.wiki.mekanism.purificationchamber.add", type = MethodDescription.Type.ADDITION, example = @Example(value = "item('minecraft:diamond'), gas('oxygen'), item('minecraft:nether_star')", commented = true))
