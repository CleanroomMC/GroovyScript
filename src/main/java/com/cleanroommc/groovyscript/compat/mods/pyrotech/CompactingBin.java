...
@RegistryDescription
public class CompactingBin extends ForgeRegistryWrapper<CompactingBinRecipe> implements IJEIRemoval.Default {
    ...
    public @NotNull Collection<String> getCategories() {
        return Collections.singletonList(JEIRecipeCategoryCompactingBin.UID);
    }
