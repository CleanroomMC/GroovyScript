...
@RegistryDescription
public class Kiln extends ForgeRegistryWrapper<KilnPitRecipe> implements IJEIRemoval.Default {
    ...
    public @NotNull Collection<String> getCategories() {
        return Collections.singletonList(JEIRecipeCategoryKilnPit.UID);
    }
