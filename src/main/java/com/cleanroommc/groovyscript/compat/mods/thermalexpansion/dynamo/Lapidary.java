...
@RegistryDescription
public class Lapidary extends VirtualizedRegistry<Lapidary.LapidaryRecipe> implements IJEIRemoval.Default {
    ...
    public @NotNull Collection<String> getCategories() {
        return Collections.singletonList(RecipeUidsTE.DYNAMO_NUMISMATIC_GEM);
    }
