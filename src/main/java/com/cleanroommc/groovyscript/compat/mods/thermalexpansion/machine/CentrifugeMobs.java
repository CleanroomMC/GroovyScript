...
@RegistryDescription
public class CentrifugeMobs extends VirtualizedRegistry<CentrifugeRecipe> implements IJEIRemoval.Default {
    ...
    public @NotNull Collection<String> getCategories() {
        return Collections.singletonList(RecipeUidsTE.CENTRIFUGE_MOBS);
    }
