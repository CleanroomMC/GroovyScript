...
@RegistryDescription
public class BrewRecipe extends VirtualizedRegistry<RecipeBrew> implements IJEIRemoval.Default {
    ...
    public @NotNull Collection<String> getCategories() {
        return Collections.singletonList(BreweryRecipeCategory.UID);
    }
