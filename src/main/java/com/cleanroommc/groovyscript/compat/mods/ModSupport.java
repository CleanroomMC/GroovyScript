...
public class ModSupport implements IDynamicGroovyProperty {
    ...
    public static final GroovyContainer<PneumaticCraft> PNEUMATICRAFT = new InternalModContainer<>("pneumaticcraft", "PneumaticCraft: Repressurized", PneumaticCraft::new);
