...
import com.cleanroommc.groovyscript.compat.mods.pneumaticraft.Pneumaticraft;
...
public class ModSupport implements IDynamicGroovyProperty {
    ...
    public static final GroovyContainer<Pneumaticraft> PNEUMATICRAFT = new InternalModContainer<>("pneumaticcraft", "PneumaticCraft: Repressurized", Pneumaticraft::new);
