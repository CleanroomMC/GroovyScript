...
public class MobConfig extends VirtualizedRegistry<Pair<String, Integer>> {
    ...
    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.add_normal", type = MethodDescription.Type.ADDITION)
    ...
    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.add_normal", type = MethodDescription.Type.ADDITION, example = @Example("'minecraft:zombie', 'spawn_ticks', 1"))
    ...
    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.add_global", type = MethodDescription.Type.ADDITION)
    ...
    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.add_global", type = MethodDescription.Type.ADDITION, example = @Example("'spawn_ticks', 100"))
    public void add(String key, int value) {
        add(EnumConfigKey.get(key.toUpperCase(Locale.ROOT)), value);
    }

    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.remove")
    ...
    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.remove", example = @Example("'minecraft:wither_skeleton', 'spawn_units'"))
    public void remove(String name, String key) {
        remove(new WootMobName(name), EnumConfigKey.get(key.toUpperCase(Locale.ROOT)));
    }

    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.removeByEntity", example = @Example("'minecraft:wither'"))
    ...
    @MethodDescription(description = "groovyscript.wiki.woot.mobconfig.removeByEntity")
