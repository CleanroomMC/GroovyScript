...
public class GSCommand extends CommandTreeBase {
    ...
    public GSCommand() {
        ...
        addSubcommand(
                new SimpleCommand(
                        ...
                        (server, sender, args) -> sender.sendMessage(
                                new TextComponentString("GroovyScript wiki")
                                        .setStyle(
                                                new Style()
        ...
        addSubcommand(new SimpleCommand("generateWiki", (server, sender, args) -> {
            ...
            sender.sendMessage(
                    new TextComponentString("Generated a local version of the Groovyscript wiki has been generated to the ")
        ...
        addSubcommand(new SimpleCommand("generateExamples", (server, sender, args) -> {
            ...
            sender.sendMessage(
                    new TextComponentString("Generated examples for the enabled Groovyscript compat to the ")
        ...
        addSubcommand(new SimpleCommand("creativeTabs", (server, sender, args) -> {
            ...
            sender.sendMessage(
                    new TextComponentString("Creative tabs has been logged to the ")
