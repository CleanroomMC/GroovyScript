...
public abstract class AbstractCompileCustomizer extends CompilationCustomizer {
    ...
    public AbstractCompileCustomizer(CompilePhase phase) {
        super(phase);
    }

    @Override
    public void call(SourceUnit source, GeneratorContext context, ClassNode classNode) throws CompilationFailedException {
        AbstractTransformer visitor = createTransformer(source, classNode);
    ...
    protected abstract AbstractTransformer createTransformer(SourceUnit source, ClassNode classNode);
