...
public class CachedClassFieldsVisitor extends ClassVisitor implements Opcodes {
    ...
    public static class InitFieldVisitor extends MethodVisitor {
        ...
        public void visitInvokeDynamicInsn(String name, String desc, Handle bsm, Object... bsmArgs) {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "com/cleanroommc/groovyscript/sandbox/mapper/RemappedCachedField", "makeFieldsHook", "(L" + CLASS_NAME_2 + ";)Ljava/security/PrivilegedAction;", false);
        }
    }
}
