...
public class CachedClassMethodsVisitor extends ClassVisitor implements Opcodes {
    ...
    public static class InitMethodVisitor extends MethodVisitor {
        ...
        public void visitInvokeDynamicInsn(String name, String desc, Handle bsm, Object... bsmArgs) {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "com/cleanroommc/groovyscript/sandbox/mapper/RemappedCachedMethod", "makeMethodsHook", "(L" + CLASS_NAME_2 + ";)Ljava/security/PrivilegedAction;", false);
        }
    }
}
