...
public class SandboxTransformer extends CompilationCustomizer {
    ...
    public void call(final SourceUnit source, GeneratorContext context, ClassNode classNode) {
        ...
        processConstructors(visitor, classNode, source);
     ...
     * }</pre>
     */
    public void processConstructors(final ClassCodeExpressionTransformer visitor, ClassNode classNode, SourceUnit sourceUnit) {
    ...
    class VisitorImpl extends ScopeTrackingClassCodeExpressionTransformer {
        ...
        ConstantExpression constExp(Object o) {
