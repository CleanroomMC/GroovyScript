...
// Chaos Altar:
// Converts an input item into an output itemstack with an optional catalyst, consuming a specified amount of Chaos from a
// Chaos Altar. Chaos is consumed at a maximum of 400 per tick, meaning the time taken corresponds to the Chaos cost.
